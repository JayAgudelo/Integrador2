...
const translations: Record<Locale, Messages> = {
  en: {
    ...
    "upload.progressBodyLongWait": "Processing is still underway. This request may take a bit longer if the backend is busy.",
    "search.progressBodyLongWait": "Processing is still underway. This request may take a bit longer if the backend is busy.",
...
translations.es = {
  ...
  "upload.progressBodyLongWait": "El procesamiento aún continúa. Esta solicitud puede tardar un poco más si el backend está ocupado.",
  "search.progressBodyLongWait": "El procesamiento aún continúa. Esta solicitud puede tardar un poco más si el backend está ocupado.",
...
translations.fr = {
  ...
  "upload.progressBodyLongWait": "Le traitement est toujours en cours. Cette requête peut prendre un peu plus de temps si le backend est occupé.",
  "search.progressBodyLongWait": "Le traitement est toujours en cours. Cette requête peut prendre un peu plus de temps si le backend est occupé.",
